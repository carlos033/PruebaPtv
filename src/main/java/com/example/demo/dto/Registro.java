...
public class Registro implements Serializable {
    ...
    public Registro(String codTecnico, String nombre, String email, String delegacion, int puntos, String cargo) {
    ...
    public String toString() {
        return "Registro{" + "codTecnico=" + codTecnico + ", nombre=" + nombre + ", email=" + email + ", delegacion=" + delegacion + ", puntos=" + puntos + ", cargo=" + cargo + '}';
    }
